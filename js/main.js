...
require(['jquery','mmGrid'], function($){
    ...
    $(document).ready(function(){
        ...
        var cols = [
            { title:'股票代码', name:'SECUCODE' ,width:100, sortable: true, align:'center' ,lockDisplay: true },
            { title:'股票名称', name:'SECUABBR' ,width:100, sortable: true, align:'center' ,lockDisplay: true},
